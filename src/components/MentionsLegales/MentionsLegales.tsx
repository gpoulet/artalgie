...
import ArtalgieLink from "./ArtalgieLink";
      ...
      <div className="card">
        <div className="card-content">
          ...
          <p>En vertu de l’article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans
            l’économie numérique, il est précisé aux utilisateurs du site <ArtalgieLink/> l’identité des
          ...
          <p>
            L’utilisation du site <ArtalgieLink/> implique l’acceptation pleine et entière des conditions
            générales d’utilisation ci-après décrites. Ces conditions d’utilisation sont susceptibles
            d’être modifiées ou complétées à tout moment, les utilisateurs du site <ArtalgieLink/> sont donc invités à
          ...
          <br/>
          <p>
            Le site <ArtalgieLink/> est mis à jour régulièrement par Nathalie Poulet-Guilbert. De la
          ...
          <p>
            Le site <ArtalgieLink/> a pour objet de fournir une information concernant l’ensemble des
            activités de la société.</p>
          <p>
            Nathalie Poulet-Guilbert s’efforce de fournir sur le site <ArtalgieLink/> des informations
          ...
          <p>
            Tous les informations indiquées sur le site <ArtalgieLink/> sont données à titre indicatif,
            et sont susceptibles d’évoluer. Par ailleurs, les renseignements figurant sur le site
            <ArtalgieLink/> ne sont pas exhaustifs. Ils sont donnés sous réserve de modifications
          ...
          <p>
            ...
            indirects causés au matériel de l’utilisateur, lors de l’accès au site <ArtalgieLink/>, et
          ...
          <p>
            ...
            l’utilisation du site <ArtalgieLink/>.</p>
          <p>
          ...
          <p>
            A l’occasion de l’utilisation du site <ArtalgieLink/>, peuvent être recueillies : l’URL des liens par
            l’intermédiaire desquels l’utilisateur a accédé au site <ArtalgieLink/>, le fournisseur d’accès de
            ...
            l’utilisateur que pour le besoin de certains services proposés par le site <ArtalgieLink/>. L’utilisateur
            fournit ces informations en toute connaissance de cause, notamment lorsqu’il procède par lui-même à leur
            saisie. Il est alors précisé à l’utilisateur du site <ArtalgieLink/> l’obligation ou non de fournir ces
            informations.
          </p>
          <p>
          ...
          <p>
            Aucune information personnelle de l’utilisateur du site <ArtalgieLink/> n’est publiée à l’insu de
            ...
            modification des données vis-à-vis de l’utilisateur du site <ArtalgieLink/>.
          </p>
          ...
          <p>Le site <ArtalgieLink/> contient un certain nombre de liens hypertextes vers d’autres sites, mis en place
          ...
          <p>
            La navigation sur le site <ArtalgieLink/> est susceptible de provoquer l’installation de cookie(s) sur
          ...
          <p>
            Tout litige en relation avec l’utilisation du site <ArtalgieLink/> est soumis au droit français. Il est

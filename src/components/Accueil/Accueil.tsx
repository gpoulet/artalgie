  ...
  <div className="accueil">
    ...
    <div className="row row-accueil beige-light">
      <div className="col s12 center-align">
        ...
        <p className="accueil-text">Entreprises : Elle vous accompagne dans les étapes de l'expression de votre besoin à
          la mise en
    ...
    <div className="row row-accueil beige-light">
      <div className="col s12 center-align">
        ...
        <p className="accueil-text">Vous voulez en savoir plus sur les prestations, et les modalités
          d'intervention...</p>
        <br/>
